...
public class PropertyCount {
	...
	public static final String TAG = PropertyCount.class.getSimpleName();
		...
		for (int i = 1000; i < 10000; i = i + 1000) {
			...
			for (XmlLink xmlLink : xmlLinks)
				try {
					...
					Log.e(TAG, "error parsing codice doc");
				}
		}
	 ...
	 *            </ul>
	 *            example <i>jdbc:mysql://localhost:4406/licitaciones peter
	 *            Gr1Ff1N</i>
	 */
	public static void main(String[] args) {

		if (args.length != 3) {
			Log.e(TAG, "usage: Test database/table_URL username password");
			return;
		}
