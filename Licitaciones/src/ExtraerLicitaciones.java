...
public class ExtraerLicitaciones {
	...
	public String accederPrimeraPaginaLicitaciones(BaseDatos bd,String bas,String url,Map<String, String> cookies,Estadisticas estadisticas){
		...
		String[] l;
			try {
				...
				*/
				...
				doc = response.parse();
				respuesta=buscarPatronHref(doc,"Búsqueda avanzada de licitaciones");
				...
				response= Jsoup.connect(respuesta)
				           .ignoreContentType(true)
				           .userAgent("Mozilla/5.0 (Windows NT 6.1; WOW64; rv:27.0) Gecko/20100101 Firefox/27.0")
				           .referrer(url)   
				           .timeout(12000) 
				...
				for (Element link : links) {
					if (link.attr("abs:id").contains("viewns_Z7_AVEQAI930OBRD02JPMTPG21004_:form1")){
						respuesta=new String(link.attr("abs:action"));  // Capturo el Link
						//System.out.println("IIIIIIIIIIIDDDDDDDDDDDDDDD    "+  link.id());
						String descripcion=new String(trim(link.text(), 35)); // Capturo la de
...
//			    System.exit(0);
				...
				response= Jsoup.connect(peticion)
				           .ignoreContentType(true)
				           .userAgent("Mozilla/5.0 (Windows NT 6.1; WOW64; rv:27.0) Gecko/20100101 Firefox/27.0")
				           .timeout(12000) 
				           .followRedirects(true)
	...
	public boolean fin(Document doc,Estadisticas estadisticas){
		...
		String []aux;
		/*
		aux=p.search("span id=\"viewns_Z7_AVEQAI930OBRD02JPMTPG21004_:form1:textfooterInfoNumPagMAQ\" class=\"outputText marginLeft0punto5\">[\\d]*</span>", doc.html());
		for (int i=0;aux.length>i;i++){
			pActual=aux[i].replaceAll("span id=\"viewns_Z7_AVEQAI930OBRD02JPMTPG21004_:form1:textfooterInfoNumPagMAQ\" class=\"outputText marginLeft0punto5\">", "");
			pActual=pActual.replaceAll("</span>", "");
			
		}
		
		aux=p.search("span id=\"viewns_Z7_AVEQAI930OBRD02JPMTPG21004_:form1:textfooterInfoTotalPaginaMAQ\" class=\"outputText marginLeft0punto5\">[\\d]*</span>", doc.html());
		for (int i=0;aux.length>i;i++){
			pFinal=aux[i].replaceAll("span id=\"viewns_Z7_AVEQAI930OBRD02JPMTPG21004_:form1:textfooterInfoTotalPaginaMAQ\" class=\"outputText marginLeft0punto5\">", "");
		...
		*/
		...
		if (PaginaFinal==PaginaActual){ // si llege al final
			fin=true;
			System.out.println("\n\n\n**********************************************************************************************************");
			System.out.println("**********************************************************************************************************");
			System.out.println("**********************************************************************************************************\n");
			...
			System.out.printf("\nPagina actual  [%d],Paginas Totales  [%d],Porcentaje conpletado [%.4f%%]", Double.parseDouble(pActual),Double.parseDouble(pFinal),por);
			System.out.println("\n**********************************************************************************************************");
			System.out.println("**********************************************************************************************************");
			System.out.println("**********************************************************************************************************\n\n");
		} else {
			System.out.println("\n\n----------------------------------------------------------------------------------------------------------\n");
			double por=((PaginaActual*(1.0))/(PaginaFinal*(1.0)))*100.0;	
			System.out.printf("\nPagina actual  [%d],Paginas Totales  [%d],Porcentaje conpletado [%.4f%%],Enalces capturados [%d]", PaginaActual,PaginaFinal,por,estadisticas.getEnlacesCapturados());
	...
	public Document iterarPaginas(Document doc,String id,Map<String, String> cookies,Estadisticas estadisticas,BaseDatos bd){
		Elements links = doc.select("form[id]");
		Patrones p= new Patrones();
		...
		for (Element link : links) {
			if (link.attr("abs:id").contains("viewns_Z7_AVEQAI930OBRD02JPMTPG21004_:form1")){
				formulario=new String(link.attr("abs:action"));  // Capturo el Link
				//System.out.println("IIIIIIIIIIIDDDDDDDDDDDDDDD    "+  link.id());
				//String descripcion=new String(trim(link.text(), 35)); // Capturo la de
		...
		String peticion=formulario+"?CpvorigenmultiplecpvMultiple=BusquedaVIS_UOE&cpvPrincipalmultiplecpvMultiple=&cpvViewmultiplecpvMultiple=%23%7BbeanCpvPpt.cpv%7D&javax.faces.ViewState=j_id"
				+pag[0]+"%3Aj_id"+pag[1]+"&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1=viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3AcomboTipoAdminMAQ=00&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3Acomboadmins=00&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3AcpvMultiple%3AcodigoCpv=&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3AfAdjuOtrosDatos1MAQ=&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3AfAdjuOtrosDatos2MAQ=&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3AfBOEOtrosDatos1MAQ=&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3AfBOEOtrosDatos2MAQ=&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3AfBOEPubMaxMAQvis=&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3AfBOEPubMinMAQvis2=&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3AfDOUEOtrosDatos1MAQ=&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3AfDOUEOtrosDatos2MAQ=&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3AfDOUEPubMaxMAQvis=&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3AfDOUEPubMinMAQvis=&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3AfPresOtrosDatos1MAQ=&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3AfPresOtrosDatos2MAQ=&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3AfooterSiguiente=Siguiente&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3AhiddenBusquedaOtrosDatos=true&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3Amenu111MAQ=00&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3Amenu1MAQ1=00&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3AmenuCompraPublicaInnovadoraMAQ1=00&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3AmenuSubtipoMAQ=00&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3AmenuTipoContMAQ=00&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3As_detLicitacionAnulMAQ=00&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3As_detLicitacionMAQ=00&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3AtexoorganoMAQ=&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3Atext18MAQ=&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3Atext19MAQ=&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3Atext71ExpMAQ=&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3AtextEstimado18MAQ=&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3AtextEstimado19MAQ=&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3AtextMaxFecAnuncioMAQ=&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3AtextMinFecAnuncioMAQ2=&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3Atextoministerio=&viewns_Z7_AVEQAI930OBRD02JPMTPG21004_%3Aform1%3AtipoSistemaContratacion=0";
		
		try {
			System.out.println("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxPeticion:   "+peticion);
			Response response= Jsoup.connect(peticion)
			           .ignoreContentType(true)
			           .userAgent("Mozilla/5.0 (Windows NT 6.1; WOW64; rv:27.0) Gecko/20100101 Firefox/27.0")
			           .timeout(12000) 
			           .followRedirects(true)
	...
	public int buscarLicitaciones (String [] licitaciones,String id,Estadisticas estadisticas,BaseDatos bd){
		int num;
		...
		for (int i=0;licitaciones.length>i;i++){
			...
			try {
				Response respuesta= Jsoup.connect(url+parametros)
				           .ignoreContentType(true)
				           .userAgent("Mozilla/5.0 (Windows NT 6.1; WOW64; rv:27.0) Gecko/20100101 Firefox/27.0")
				           .timeout(12000) 
				           .followRedirects(true)
				...
				ArrayList<String> coincidencias= buscarPatronHrefXml(doc,estadisticas,bd);
	...
	public String[] idLicitacion (Document doc){
		   ...
		   //System.out.println("======================================================================================\n\n");
		   Patrones p = new Patrones();
		   String[] coincidencias = p.search("idLicitacion':'\\d\\d\\d\\d\\d\\d\\d\\d",doc.html() );
	...
	public  String buscarPatronHref(Document d, String p){
		...
		String referencia = null;
		   for (Element link : links) {
				String enlace=new String(link.attr("abs:href"));  // Capturo el Link
				String descripcion=new String(trim(link.text(), 35)); // Capturo la de
	...
	public  ArrayList<String> buscarPatronHrefXml(Document d,Estadisticas estadisticas,BaseDatos bd){
				...
				if (descripcion.trim().toLowerCase().contains("xml")){
					...
					if (!estadisticas.getXml().containsKey(enlace)){
						...
						bd.insertarLinkLicitacion(enlace, exp,xml2,post);
							...
							System.out.println("----------------------------->>>>>>>   Enlace XML duplicado:   "+enlace);
						}
				}
		   }
		   return encontrados;
	...
	dtm.CrearConexionHTTPS();
      ...
      try {
         ...
         for (int i=0;url2.length>i;i++){
        	 newURL=url2[i].replaceAll("url='", "https://contrataciondelestado.es");
        	 break;
         }
